...
def listgrup():
    listGrup =  """💢คำสั่งตั้งค่า ─┅═ই☣さণさโบ้☣ই═┅─💢
...
def helptexttospeech():
    helpTextToSpeech =   """💠คำสั่งเลียนแบบComBo&BotSelf💠
🌏 เลียนแบบ on/off 
🌏 เลียนแบบ 
🌏 เพิ่มเลียนแบบ (@) 
🌏 ลบเลียนแบบ (@)"""
...
def helplanguange():
    helpLanguange =    """💨คำสั่งล่องหนComBo&BOT💨
⚓!แทค
⚓!มิด
⚓!คท"""
...
#===============หาชื่อล่อนหน===============================================================#
                    ...
                    line.sendMessage(to, "☣さণさโบ้☣กำลังโหลด:▒...0%")
                    ...
                    line.sendMessage(to, " 🔋☣さণさโบ้☣ ยังอยู่ครับ✔")
                    ...
                    start = time.time()
                    line.sendMessage(to,"ความเร็วของ ☣さণさโบ้☣ Self...")
        ...
        if op.type == 26:
            ...
            if msg.toType == 0:
                ...
                if msg.text in ["speed","sp","Speed","สปีด","!speed","/speed"]:
                    line.sendText(msg.to,"แรงขนาดนี้ โบ้นี่ชูนิ้วกลางเลย🖕")
                ...
                if msg.text in ["555","5555","55555","55+","55++","555+","555++","5555+","5555++"]:
                    line.sendText(msg.to,"โบ้ว่าอาการหนักนะเนี๊ยะ!!. อิอิ😝😝")				
